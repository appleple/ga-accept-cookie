...
export default (function (trackingCode, /*UA-XXXX-Y*/ option) {
    var _a = __assign({}, defaultOption, option), debuglog = _a.debuglog, storageName = _a.storageName, acceptBtnLabel = _a.acceptBtnLabel, cancelBtnLabel = _a.cancelBtnLabel, acceptBoxText = _a.acceptBoxText;
